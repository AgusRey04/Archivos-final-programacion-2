...
def superposicion_any(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    """
    return any(x for x in lista_1 if x in lista_2) #La función any toma una secuencia de valores booleanos y devuelve True si al menos uno de los valores es True.
