...
print(Cliente["DNI"])
# COMPLETAR - FIN
print(Cliente["Nombre"] == "Mario Pedernera")and (Cliente["DNI"] == 56895632)and (Cliente["Domicilio"] == "Los alamos 4509")and (Cliente["Compras"] == ["cafetera", "TV 50 pulgadas", "mouse gamer"])
assert (
...
# COMPLETAR - FIN
print((Compras["Mario Pedernera"] == ["cafetera", "TV 50 pulgads", "mouse gamer"])
...
palabra = "reconocer"
lista_palabra_reverse = list(palabra)
print(lista_palabra_reverse)
lista_palabra_reverse.reverse()
print(lista_palabra_reverse)
palabra_reverse = "".join(lista_palabra_reverse)
